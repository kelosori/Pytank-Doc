...
|----------------------------------------------------|------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[Well](/nav/API/well_api/)**                     | `no methods`                                                           | -                                                                                                                                                                               |
| **[Oil_Model](/nav/API/generated/oil_model/)**     | `get_bg_at_press(p)`                                                   | Method to interpolate gas volumetric factor (Bg).                                                                                                                               |
...
| **[Water_Model](/nav/API/generated/water_model/)** | `get_bw_at_press(p)`                                                   | Method to calculate the water volumetric factor Bw using correlation.                                                                                                           |
...
| **[Tank](/nav/API/tank_api/)**                     | `get_pressure_df(p)`                                                   | Gets a DatFrame with pressure data.                                                                                                                                             |
|                                                    | `get_prodcution_df(p)`                                                 | Gets a DatFrame with production data.                                                                                                                                           |
| **[Analysis](/nav/API/analysis_api/)**             | `analytic_method(poes, option)`                                        | Method used to calculate the POES through an inferred POES that ensures that there is the best match between the behavior of the observed pressure and the calculated pressure. |
...
|--------------------------------------|--------------------------------------------------------------------|-------------------------------------------------------------------------------|
| **[Helpers](/nav/API/helpers/)**     | `create_wells(df_prod, df_press, freq_prod=None, freq_press=None)` | Returns A list of Wells objects.                                              |
|                                      | `search_wells(wells, well_names)`                                  | Searches for wells in the list of all wells based on the provided well names. |
| **[Vectors](/nav/API/vector_data/)** | `InjVector`                                                        | This class is used to handle injection data with a specific scheme.           |
...
- **[PVT Correlations](/nav/API/generated/pvt_correlations/)**
